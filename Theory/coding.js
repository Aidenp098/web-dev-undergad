function display2_1() {
  var myanswer  = "The first statement will output 'undefined'. The second and third will give a reference error saying NULL is not defined. NULL and undefined are two distinct types." // TODO 2.1: Fill in Answer here after the :
  document.getElementById("21answer").innerHTML = myanswer; // Do not change
}
function display2_2() {
  var myanswer  = "This will recieve a reference error because x is not defined. Nothing would change if you remove 'use strict' other than not enabling strict mode." // TODO 2.2: Fill in Answer here
  document.getElementById("22answer").innerHTML = myanswer; // Do not change
}

function display2_5() {
  var myanswer  = "The style tag is set to display none. This is why you can't see them on the page." // TODO 2.5: Fill in Answer here
